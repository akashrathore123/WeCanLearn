 ...
 */
ObjectOperations.prototype.getCurrentUser = function (options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ObjectOperations.prototype.getObjectsByObjectIds = function (parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ObjectOperations.prototype.getObjectsByObjectIdsNext = function (nextLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
