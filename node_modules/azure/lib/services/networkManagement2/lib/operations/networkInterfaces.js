 ...
 *
 *                      {object} [result]   - The deserialized result object.
 *                      See {@link EffectiveNetworkSecurityGroupListResult}
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
NetworkInterfaces.prototype.getEffectiveRouteTableNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginGetEffectiveRouteTableNext(nextPageLink, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
NetworkInterfaces.prototype.beginGetEffectiveRouteTableNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
NetworkInterfaces.prototype.listEffectiveNetworkSecurityGroupsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginListEffectiveNetworkSecurityGroupsNext(nextPageLink, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
NetworkInterfaces.prototype.beginListEffectiveNetworkSecurityGroupsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
