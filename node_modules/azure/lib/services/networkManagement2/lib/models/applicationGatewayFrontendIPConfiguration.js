...
function ApplicationGatewayFrontendIPConfiguration() {
  ApplicationGatewayFrontendIPConfiguration['super_'].call(this);
}

util.inherits(ApplicationGatewayFrontendIPConfiguration, models['SubResource']);
 ...
 *
 */
ApplicationGatewayFrontendIPConfiguration.prototype.mapper = function () {
  return {
    required: false,
