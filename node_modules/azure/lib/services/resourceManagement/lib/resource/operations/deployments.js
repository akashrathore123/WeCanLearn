 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Deployments.prototype.createOrUpdate = function (resourceGroupName, deploymentName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginCreateOrUpdate(resourceGroupName, deploymentName, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Deployments.prototype.beginCreateOrUpdate = function (resourceGroupName, deploymentName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  if (properties !== null && properties !== undefined) {
      parameters = new client.models['Deployment']();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Deployments.prototype.validate = function (resourceGroupName, deploymentName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
