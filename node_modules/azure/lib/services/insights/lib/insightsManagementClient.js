...
var InsightsManagementClient = ( /** @lends InsightsManagementClient */ function() {
  ...
  function InsightsManagementClient(credentials, baseUri, filters) {
    ...
    /**
     * Provides an instance of the
     * [LogProfilesOperations](-LogProfilesOperations.html) object.
     * @type {object}
     */
    this.logProfilesOperations = new LogProfilesOperations(this);
    /**
     * Provides an instance of the
...
var AlertOperations = ( /** @lends AlertOperations */ function() {
   ...
   * 
   * @param {array} [parameters.properties.actions] Gets or sets the actions
   * that are performed when the alert rule becomes active, and when an alert
  ...
  AlertOperations.prototype.createOrUpdateRule = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.actions !== null && parameters.properties.actions !== undefined) {
        var actionsArray = [];
        for (var loweredIndex1 = 0; loweredIndex1 < parameters.properties.actions.length; loweredIndex1 = loweredIndex1 + 1) {
          var actionsItem = parameters.properties.actions[loweredIndex1];
          var ruleActionValue = {};
          actionsArray.push(ruleActionValue);
          if (actionsItem.type === 'Microsoft.Azure.Management.Insights.Models.RuleEmailAction') {
            ruleActionValue['odata.type'] = actionsItem.type;
            var derived10 = actionsItem;
            ...
            if (derived10.customEmails !== null && derived10.customEmails !== undefined) {
              ...
              for (var loweredIndex2 = 0; loweredIndex2 < derived10.customEmails.length; loweredIndex2 = loweredIndex2 + 1) {
                var customEmailsItem = derived10.customEmails[loweredIndex2];
                customEmailsArray.push(customEmailsItem);
              }
              ruleActionValue['customEmails'] = customEmailsArray;
            }
          }
          if (actionsItem.type === 'Microsoft.Azure.Management.Insights.Models.RuleWebhookAction') {
            ruleActionValue['odata.type'] = actionsItem.type;
            var derived11 = actionsItem;
            
            if (derived11.serviceUri !== null && derived11.serviceUri !== undefined) {
              ruleActionValue['serviceUri'] = derived11.serviceUri;
            }
            
            if (derived11.properties !== null && derived11.properties !== undefined) {
              var propertiesDictionary = {};
              for (var propertiesKey in derived11.properties) {
                var propertiesValue2 = derived11.properties[propertiesKey];
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          var propertiesValue = responseDoc['properties'];
          if (propertiesValue !== null && propertiesValue !== undefined) {
            var propertiesInstance = { actions: [] };
            result.properties = propertiesInstance;
            ...
            var actionsArray = propertiesValue['actions'];
            if (actionsArray !== null && actionsArray !== undefined) {
              for (var loweredIndex1 = 0; loweredIndex1 < actionsArray.length; loweredIndex1 = loweredIndex1 + 1) {
                ...
                var typeName5 = actionsValue['odata.type'];
                if (typeName5 === 'Microsoft.Azure.Management.Insights.Models.RuleEmailAction') {
                  ...
                  propertiesInstance.actions.push(ruleEmailActionInstance);
                }
                if (typeName5 === 'Microsoft.Azure.Management.Insights.Models.RuleWebhookAction') {
                  var ruleWebhookActionInstance = { properties: {} };
                  
                  var serviceUriValue = actionsValue['serviceUri'];
                  if (serviceUriValue !== null && serviceUriValue !== undefined) {
                    var serviceUriInstance = serviceUriValue;
                    ruleWebhookActionInstance.serviceUri = serviceUriInstance;
                  }
                  
                  var propertiesSequenceElement = actionsValue['properties'];
                  if (propertiesSequenceElement !== null && propertiesSequenceElement !== undefined) {
                    for (var property2 in propertiesSequenceElement) {
                      ...
                      var propertiesValue2 = propertiesSequenceElement[property2];
                      ruleWebhookActionInstance.properties[propertiesKey] = propertiesValue2;
                    }
                  }
                  propertiesInstance.actions.push(ruleWebhookActionInstance);
                }
              }
            }
...
var AutoscaleOperations = ( /** @lends AutoscaleOperations */ function() {
   ...
   * specified.
   * 
   * @param {array} [parameters.properties.notifications] Gets or sets the
  ...
  AutoscaleOperations.prototype.createOrUpdateSetting = function(resourceGroupName, autoscaleSettingName, parameters, callback) {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.notifications !== null && parameters.properties.notifications !== undefined) {
        var notificationsArray = [];
        for (var loweredIndex6 = 0; loweredIndex6 < parameters.properties.notifications.length; loweredIndex6 = loweredIndex6 + 1) {
          var notificationsItem = parameters.properties.notifications[loweredIndex6];
          var notificationValue = {};
          notificationsArray.push(notificationValue);
          
          if (notificationsItem.operation !== null && notificationsItem.operation !== undefined) {
            notificationValue['operation'] = notificationsItem.operation;
          }
          
          if (notificationsItem.email !== null && notificationsItem.email !== undefined) {
            var emailValue = {};
            notificationValue['email'] = emailValue;
            
            if (notificationsItem.email.sendToSubscriptionAdministrator !== null && notificationsItem.email.sendToSubscriptionAdministrator !== undefined) {
              emailValue['sendToSubscriptionAdministrator'] = notificationsItem.email.sendToSubscriptionAdministrator;
            }
            
            if (notificationsItem.email.sendToSubscriptionCoAdministrators !== null && notificationsItem.email.sendToSubscriptionCoAdministrators !== undefined) {
              emailValue['sendToSubscriptionCoAdministrators'] = notificationsItem.email.sendToSubscriptionCoAdministrators;
            }
            
            if (notificationsItem.email.customEmails !== null && notificationsItem.email.customEmails !== undefined) {
              var customEmailsArray = [];
              for (var loweredIndex7 = 0; loweredIndex7 < notificationsItem.email.customEmails.length; loweredIndex7 = loweredIndex7 + 1) {
                var customEmailsItem = notificationsItem.email.customEmails[loweredIndex7];
                customEmailsArray.push(customEmailsItem);
              }
          ...
          if (notificationsItem.webhooks !== null && notificationsItem.webhooks !== undefined) {
            var webhooksArray = [];
            for (var loweredIndex8 = 0; loweredIndex8 < notificationsItem.webhooks.length; loweredIndex8 = loweredIndex8 + 1) {
              var webhooksItem = notificationsItem.webhooks[loweredIndex8];
              var webhookValue = {};
              webhooksArray.push(webhookValue);
              
              if (webhooksItem.serviceUri !== null && webhooksItem.serviceUri !== undefined) {
                webhookValue['serviceUri'] = webhooksItem.serviceUri;
              }
              
              if (webhooksItem.properties !== null && webhooksItem.properties !== undefined) {
                var propertiesDictionary = {};
                for (var propertiesKey in webhooksItem.properties) {
                  var propertiesValue2 = webhooksItem.properties[propertiesKey];
                  propertiesDictionary[propertiesKey] = propertiesValue2;
                }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          var propertiesValue = responseDoc['properties'];
          if (propertiesValue !== null && propertiesValue !== undefined) {
            var propertiesInstance = { notifications: [], profiles: [] };
            result.properties = propertiesInstance;
            ...
            var notificationsArray = propertiesValue['notifications'];
            if (notificationsArray !== null && notificationsArray !== undefined) {
              for (var loweredIndex6 = 0; loweredIndex6 < notificationsArray.length; loweredIndex6 = loweredIndex6 + 1) {
                var notificationsValue = notificationsArray[loweredIndex6];
                var notificationInstance = { webhooks: [] };
                propertiesInstance.notifications.push(notificationInstance);
                
                var operationValue = notificationsValue['operation'];
                ...
                var emailValue = notificationsValue['email'];
                if (emailValue !== null && emailValue !== undefined) {
                  var emailInstance = { customEmails: [] };
                  notificationInstance.email = emailInstance;
                  
                  var sendToSubscriptionAdministratorValue = emailValue['sendToSubscriptionAdministrator'];
                  if (sendToSubscriptionAdministratorValue !== null && sendToSubscriptionAdministratorValue !== undefined) {
                    var sendToSubscriptionAdministratorInstance = sendToSubscriptionAdministratorValue;
                    emailInstance.sendToSubscriptionAdministrator = sendToSubscriptionAdministratorInstance;
                  }
                  
                  var sendToSubscriptionCoAdministratorsValue = emailValue['sendToSubscriptionCoAdministrators'];
                  if (sendToSubscriptionCoAdministratorsValue !== null && sendToSubscriptionCoAdministratorsValue !== undefined) {
                    var sendToSubscriptionCoAdministratorsInstance = sendToSubscriptionCoAdministratorsValue;
                    emailInstance.sendToSubscriptionCoAdministrators = sendToSubscriptionCoAdministratorsInstance;
                  }
                  
                  var customEmailsArray = emailValue['customEmails'];
                  if (customEmailsArray !== null && customEmailsArray !== undefined) {
                    for (var loweredIndex7 = 0; loweredIndex7 < customEmailsArray.length; loweredIndex7 = loweredIndex7 + 1) {
                      var customEmailsValue = customEmailsArray[loweredIndex7];
                      emailInstance.customEmails.push(customEmailsValue);
                    }
                  }
                }
                
                var webhooksArray = notificationsValue['webhooks'];
                if (webhooksArray !== null && webhooksArray !== undefined) {
                  for (var loweredIndex8 = 0; loweredIndex8 < webhooksArray.length; loweredIndex8 = loweredIndex8 + 1) {
                    var webhooksValue = webhooksArray[loweredIndex8];
                    var webhookInstance = { properties: {} };
                    notificationInstance.webhooks.push(webhookInstance);
                    
                    var serviceUriValue = webhooksValue['serviceUri'];
                    if (serviceUriValue !== null && serviceUriValue !== undefined) {
                      var serviceUriInstance = serviceUriValue;
                      webhookInstance.serviceUri = serviceUriInstance;
                    }
                    
                    var propertiesSequenceElement = webhooksValue['properties'];
                    if (propertiesSequenceElement !== null && propertiesSequenceElement !== undefined) {
                      for (var property2 in propertiesSequenceElement) {
                        var propertiesKey = property2;
                        var propertiesValue2 = propertiesSequenceElement[property2];
                        webhookInstance.properties[propertiesKey] = propertiesValue2;
                      }
                    }
                  }
                }
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                var notificationsArray = propertiesValue['notifications'];
                if (notificationsArray !== null && notificationsArray !== undefined) {
                  for (var loweredIndex7 = 0; loweredIndex7 < notificationsArray.length; loweredIndex7 = loweredIndex7 + 1) {
                    var notificationsValue = notificationsArray[loweredIndex7];
                    var notificationInstance = { webhooks: [] };
                    propertiesInstance.notifications.push(notificationInstance);
                    ...
                    if (emailValue !== null && emailValue !== undefined) {
                      ...
                      var customEmailsArray = emailValue['customEmails'];
                      if (customEmailsArray !== null && customEmailsArray !== undefined) {
                        for (var loweredIndex8 = 0; loweredIndex8 < customEmailsArray.length; loweredIndex8 = loweredIndex8 + 1) {
                          var customEmailsValue = customEmailsArray[loweredIndex8];
                          emailInstance.customEmails.push(customEmailsValue);
                        }
                      }
                    }
                    ...
                    var webhooksArray = notificationsValue['webhooks'];
                    if (webhooksArray !== null && webhooksArray !== undefined) {
                      for (var loweredIndex9 = 0; loweredIndex9 < webhooksArray.length; loweredIndex9 = loweredIndex9 + 1) {
                        var webhooksValue = webhooksArray[loweredIndex9];
                        var webhookInstance = { properties: {} };
                        notificationInstance.webhooks.push(webhookInstance);
...
var LogProfilesOperations = ( /** @lends LogProfilesOperations */ function() {
  /**
   * @class
   ...
   * instance of the [InsightsManagementClient] {@link
   * InsightsManagementClient~InsightsManagementClient}.
   * See [logProfilesOperations] {@link
   ...
   * @param {InsightsManagementClient} client Reference to the service client.
   */
  function LogProfilesOperations(client) {
    this.client = client;
  }
   ...
   * 
   * @param {LogProfileCreatOrUpdateParameters} parameters Parameters supplied
   * to the operation.
   * 
   * @param {LogProfile} [parameters.properties] Gets or sets the properties of
   * the log profile.
   * 
   * @param {string} [parameters.properties.storageAccountId] Gets or sets the
   * resource id of the storage account.
   * 
   * @param {string} [parameters.properties.serviceBusRuleId] Gets or sets the
   * resource id of the service bus rule.
   * 
   * @param {array} [parameters.properties.locations] Gets or sets the
   * locations.
   * 
   * @param {array} [parameters.properties.categories]  Gets or sets the
   * categories.
   * 
   * @param {RetentionPolicy} [parameters.properties.retentionPolicy] Gets or
   * sets the retention policy for this log.
   * 
   * @param {boolean} [parameters.properties.retentionPolicy.enabled] Gets or
   * sets a value indicating whether the retention policy is enabled.
   * 
   * @param {number} [parameters.properties.retentionPolicy.days] Gets or sets
   ...
   * @returns {Stream} The response stream.
   */
  LogProfilesOperations.prototype.createOrUpdate = function(name, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    url2 = url2 + '/providers/microsoft.insights/logprofiles/';
    ...
    var logProfileCreatOrUpdateParametersValue = {};
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.storageAccountId !== null && parameters.properties.storageAccountId !== undefined) {
        propertiesValue['storageAccountId'] = parameters.properties.storageAccountId;
      }
      
      if (parameters.properties.serviceBusRuleId !== null && parameters.properties.serviceBusRuleId !== undefined) {
        propertiesValue['serviceBusRuleId'] = parameters.properties.serviceBusRuleId;
      }
      
      if (parameters.properties.locations !== null && parameters.properties.locations !== undefined) {
        var locationsArray = [];
        for (var loweredIndex1 = 0; loweredIndex1 < parameters.properties.locations.length; loweredIndex1 = loweredIndex1 + 1) {
          var locationsItem = parameters.properties.locations[loweredIndex1];
          locationsArray.push(locationsItem);
        }
        propertiesValue['locations'] = locationsArray;
      }
      
      if (parameters.properties.categories !== null && parameters.properties.categories !== undefined) {
        var categoriesArray = [];
        for (var loweredIndex2 = 0; loweredIndex2 < parameters.properties.categories.length; loweredIndex2 = loweredIndex2 + 1) {
          var categoriesItem = parameters.properties.categories[loweredIndex2];
          categoriesArray.push(categoriesItem);
        }
        propertiesValue['categories'] = categoriesArray;
      }
      
      if (parameters.properties.retentionPolicy !== null && parameters.properties.retentionPolicy !== undefined) {
        var retentionPolicyValue = {};
        propertiesValue['retentionPolicy'] = retentionPolicyValue;
        
        if (parameters.properties.retentionPolicy.enabled !== null && parameters.properties.retentionPolicy.enabled !== undefined) {
          retentionPolicyValue['enabled'] = parameters.properties.retentionPolicy.enabled;
        }
        
        if (parameters.properties.retentionPolicy.days !== null && parameters.properties.retentionPolicy.days !== undefined) {
   ...
   * @returns {Stream} The response stream.
   */
  LogProfilesOperations.prototype.deleteMethod = function(name, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  LogProfilesOperations.prototype.get = function(name, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          var propertiesValue = responseDoc['properties'];
          if (propertiesValue !== null && propertiesValue !== undefined) {
            var propertiesInstance = { categories: [], locations: [] };
            result.properties = propertiesInstance;
            
            var storageAccountIdValue = propertiesValue['storageAccountId'];
            if (storageAccountIdValue !== null && storageAccountIdValue !== undefined) {
              var storageAccountIdInstance = storageAccountIdValue;
              propertiesInstance.storageAccountId = storageAccountIdInstance;
            }
            
            var serviceBusRuleIdValue = propertiesValue['serviceBusRuleId'];
            if (serviceBusRuleIdValue !== null && serviceBusRuleIdValue !== undefined) {
              var serviceBusRuleIdInstance = serviceBusRuleIdValue;
              propertiesInstance.serviceBusRuleId = serviceBusRuleIdInstance;
            }
            
            var locationsArray = propertiesValue['locations'];
            if (locationsArray !== null && locationsArray !== undefined) {
              for (var loweredIndex1 = 0; loweredIndex1 < locationsArray.length; loweredIndex1 = loweredIndex1 + 1) {
                var locationsValue = locationsArray[loweredIndex1];
                propertiesInstance.locations.push(locationsValue);
              }
            }
            
            var categoriesArray = propertiesValue['categories'];
            if (categoriesArray !== null && categoriesArray !== undefined) {
              for (var loweredIndex2 = 0; loweredIndex2 < categoriesArray.length; loweredIndex2 = loweredIndex2 + 1) {
                var categoriesValue = categoriesArray[loweredIndex2];
                propertiesInstance.categories.push(categoriesValue);
              }
            }
            ...
            if (retentionPolicyValue !== null && retentionPolicyValue !== undefined) {
              ...
              var enabledValue = retentionPolicyValue['enabled'];
              if (enabledValue !== null && enabledValue !== undefined) {
                var enabledInstance = enabledValue;
                retentionPolicyInstance.enabled = enabledInstance;
              }
              
              var daysValue = retentionPolicyValue['days'];
              if (daysValue !== null && daysValue !== undefined) {
                var daysInstance = daysValue;
   ...
   * @returns {Stream} The response stream.
   */
  LogProfilesOperations.prototype.list = function(callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          var logProfileCollectionInstance = { value: [] };
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              var valueValue = valueArray[loweredIndex1];
              var logProfileResourceInstance = {};
              logProfileCollectionInstance.value.push(logProfileResourceInstance);
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                var categoriesArray = propertiesValue['categories'];
                if (categoriesArray !== null && categoriesArray !== undefined) {
                  for (var loweredIndex3 = 0; loweredIndex3 < categoriesArray.length; loweredIndex3 = loweredIndex3 + 1) {
                    var categoriesValue = categoriesArray[loweredIndex3];
                    propertiesInstance.categories.push(categoriesValue);
                  }
                }
...
var ServiceDiagnosticSettingsOperations = ( /** @lends ServiceDiagnosticSettingsOperations */ function() {
  ...
  ServiceDiagnosticSettingsOperations.prototype.deleteMethod = function(resourceUri, callback) {
    ...
    url2 = url2 + '/';
    url2 = url2 + encodeURIComponent(resourceUri);
    url2 = url2 + '/providers/microsoft.insights/diagnosticSettings/service';
    var queryParameters = [];
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          var propertiesValue = responseDoc['properties'];
          if (propertiesValue !== null && propertiesValue !== undefined) {
            var propertiesInstance = { logs: [], metrics: [] };
            result.properties = propertiesInstance;
            ...
            var metricsArray = propertiesValue['metrics'];
            if (metricsArray !== null && metricsArray !== undefined) {
              for (var loweredIndex1 = 0; loweredIndex1 < metricsArray.length; loweredIndex1 = loweredIndex1 + 1) {
                var metricsValue = metricsArray[loweredIndex1];
                var metricSettingsInstance = {};
                propertiesInstance.metrics.push(metricSettingsInstance);
                
                var timeGrainValue = metricsValue['timeGrain'];
                if (timeGrainValue !== null && timeGrainValue !== undefined) {
                  var timeGrainInstance = moment.duration(timeGrainValue);
                  metricSettingsInstance.timeGrain = timeGrainInstance;
                }
                
                var enabledValue = metricsValue['enabled'];
                if (enabledValue !== null && enabledValue !== undefined) {
                  var enabledInstance = enabledValue;
                  metricSettingsInstance.enabled = enabledInstance;
                }
                
                var retentionPolicyValue = metricsValue['retentionPolicy'];
                if (retentionPolicyValue !== null && retentionPolicyValue !== undefined) {
                  var retentionPolicyInstance = {};
                  metricSettingsInstance.retentionPolicy = retentionPolicyInstance;
                  
                  var enabledValue2 = retentionPolicyValue['enabled'];
                  if (enabledValue2 !== null && enabledValue2 !== undefined) {
                    var enabledInstance2 = enabledValue2;
            ...
            var logsArray = propertiesValue['logs'];
            if (logsArray !== null && logsArray !== undefined) {
              for (var loweredIndex2 = 0; loweredIndex2 < logsArray.length; loweredIndex2 = loweredIndex2 + 1) {
                var logsValue = logsArray[loweredIndex2];
                var logSettingsInstance = {};
                propertiesInstance.logs.push(logSettingsInstance);
                
                var categoryValue = logsValue['category'];
                if (categoryValue !== null && categoryValue !== undefined) {
                  var categoryInstance = categoryValue;
                  logSettingsInstance.category = categoryInstance;
                }
                
                var enabledValue3 = logsValue['enabled'];
                if (enabledValue3 !== null && enabledValue3 !== undefined) {
                  var enabledInstance3 = enabledValue3;
                  logSettingsInstance.enabled = enabledInstance3;
                }
                
                var retentionPolicyValue2 = logsValue['retentionPolicy'];
                if (retentionPolicyValue2 !== null && retentionPolicyValue2 !== undefined) {
                  var retentionPolicyInstance2 = {};
                  logSettingsInstance.retentionPolicy = retentionPolicyInstance2;
                  
                  var enabledValue4 = retentionPolicyValue2['enabled'];
                  if (enabledValue4 !== null && enabledValue4 !== undefined) {
                    var enabledInstance4 = enabledValue4;
                    retentionPolicyInstance2.enabled = enabledInstance4;
                  }
                  
                  var daysValue2 = retentionPolicyValue2['days'];
                  if (daysValue2 !== null && daysValue2 !== undefined) {
                    var daysInstance2 = daysValue2;
   ...
   * resource id of the storage account.
   * 
   * @param {string} [parameters.properties.storageAccountName] [Deprecated]
   * Use StorageAccountId instead. Gets or sets the name of the storage
   * account.
   * 
   * @param {array} [parameters.properties.metrics] Gets or sets the list of
   * metrics.
   * 
   * @param {array} [parameters.properties.logs] Gets or sets the list of logs.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  ServiceDiagnosticSettingsOperations.prototype.put = function(resourceUri, parameters, callback) {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.metrics !== null && parameters.properties.metrics !== undefined) {
        var metricsArray = [];
        for (var loweredIndex1 = 0; loweredIndex1 < parameters.properties.metrics.length; loweredIndex1 = loweredIndex1 + 1) {
          var metricsItem = parameters.properties.metrics[loweredIndex1];
          var metricSettingsValue = {};
          metricsArray.push(metricSettingsValue);
          
          if (metricsItem.timeGrain !== null && metricsItem.timeGrain !== undefined) {
            metricSettingsValue['timeGrain'] = metricsItem.timeGrain.toISOString();
          }
          
          if (metricsItem.enabled !== null && metricsItem.enabled !== undefined) {
            metricSettingsValue['enabled'] = metricsItem.enabled;
          }
          
          if (metricsItem.retentionPolicy !== null && metricsItem.retentionPolicy !== undefined) {
            var retentionPolicyValue = {};
            metricSettingsValue['retentionPolicy'] = retentionPolicyValue;
            
            if (metricsItem.retentionPolicy.enabled !== null && metricsItem.retentionPolicy.enabled !== undefined) {
              retentionPolicyValue['enabled'] = metricsItem.retentionPolicy.enabled;
            }
            
            if (metricsItem.retentionPolicy.days !== null && metricsItem.retentionPolicy.days !== undefined) {
      ...
      if (parameters.properties.logs !== null && parameters.properties.logs !== undefined) {
        var logsArray = [];
        for (var loweredIndex2 = 0; loweredIndex2 < parameters.properties.logs.length; loweredIndex2 = loweredIndex2 + 1) {
          var logsItem = parameters.properties.logs[loweredIndex2];
          var logSettingsValue = {};
          logsArray.push(logSettingsValue);
          
          if (logsItem.category !== null && logsItem.category !== undefined) {
            logSettingsValue['category'] = logsItem.category;
          }
          
          if (logsItem.enabled !== null && logsItem.enabled !== undefined) {
            logSettingsValue['enabled'] = logsItem.enabled;
          }
          
          if (logsItem.retentionPolicy !== null && logsItem.retentionPolicy !== undefined) {
            var retentionPolicyValue2 = {};
            logSettingsValue['retentionPolicy'] = retentionPolicyValue2;
            
            if (logsItem.retentionPolicy.enabled !== null && logsItem.retentionPolicy.enabled !== undefined) {
              retentionPolicyValue2['enabled'] = logsItem.retentionPolicy.enabled;
            }
            
            if (logsItem.retentionPolicy.days !== null && logsItem.retentionPolicy.days !== undefined) {
...
var SkuOperations = ( /** @lends SkuOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  SkuOperations.prototype.getCurrentSku = function(resourceId, apiVersion, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (skuValue !== null && skuValue !== undefined) {
            ...
            var sizeValue = skuValue['size'];
            if (sizeValue !== null && sizeValue !== undefined) {
              var sizeInstance = sizeValue;
   ...
   * @returns {Stream} The response stream.
   */
  SkuOperations.prototype.listSkuDefinitions = function(resourceId, apiVersion, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * 
   * @param {string} [parameters.sku.name] Gets or sets the unique name of the
   * sku e.g. 'Free_A0'.
   * 
   * @param {string} [parameters.sku.tier] Gets or sets the tier of the sku
   * e.g. 'free'.
   * 
   * @param {string} [parameters.sku.size] Gets or sets the size of the sku
   * e.g. 'A0'.
   * 
   * @param {string} [parameters.sku.family] Gets or sets the family of the sku
   * e.g. 'A'.
   * 
   ...
   * @returns {Stream} The response stream.
   */
  SkuOperations.prototype.updateCurrentSku = function(resourceId, parameters, apiVersion, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    if (parameters.sku !== null && parameters.sku !== undefined) {
      ...
      if (parameters.sku.size !== null && parameters.sku.size !== undefined) {
