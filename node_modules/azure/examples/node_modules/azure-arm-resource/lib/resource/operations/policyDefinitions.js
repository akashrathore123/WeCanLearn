 ...
 */
function PolicyDefinitions(client) {
  this.client = client;
}
 ...
 */
PolicyDefinitions.prototype.createOrUpdate = function (policyDefinitionName, parameters, options, callback) {
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      var requestModelMapper = new client.models['PolicyDefinition']().mapper();
    ...
    if (statusCode === 201) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['PolicyDefinition']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
PolicyDefinitions.prototype.get = function (policyDefinitionName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
PolicyDefinitions.prototype.deleteMethod = function (policyDefinitionName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
