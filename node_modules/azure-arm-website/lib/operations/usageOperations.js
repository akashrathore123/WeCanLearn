 ...
 */
UsageOperations.prototype.getUsage = function (resourceGroupName, environmentName, lastId, batchSize, options, callback) {
  ...
  try {
    ...
    if (lastId === null || lastId === undefined || typeof lastId.valueOf() !== 'string') {
      throw new Error('lastId cannot be null or undefined and it must be of type string.');
    }
    if (batchSize === null || batchSize === undefined || typeof batchSize !== 'number') {
      throw new Error('batchSize cannot be null or undefined and it must be of type number.');
    }
  ...
  var queryParameters = [];
  queryParameters.push('lastId=' + encodeURIComponent(lastId));
  queryParameters.push('batchSize=' + encodeURIComponent(batchSize.toString()));
